...
var avs = new AVS({
  debug: true,
  clientId: 'amzn1.application-oa2-client.e3cfdc6abed84296ad8288b0f4fc346a',
  deviceId: 'AVSdevice',
...
chatForm.addEventListener('submit', function () {
  avs.sendChatText(chatInput.value);
});
...
var AVS = function () {
  ...
  }, 
  {
    ...
    key: 'sendChatText',
    value: function sendChatText(text) {
      var _this23 = this;
